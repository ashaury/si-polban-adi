...
<table width="830" height="78">
    <tr> 
    	<td width="100%" height="72" align="center" bgcolor="#FFCC00" style="font-size-adjust:inherit; font-size:36px; font:bold"  >Tabel Transaksi Persediaan Keluar</td>
  </tr>
    </table>

<p>&nbsp;</p>
<form action="transaksi_keluar_proses.php" method="post">
<table>
        <tr>
...
//-->            </td>
        ...
        <tr>
          ...
          <td  align="left"><input type="submit" name="button" id="button" value="tambah" />&emsp;  
                <input onclick="window.location.href='Persedian_Keluar.php'" type="button" value="batal" /></td>
        </tr>
</table>
</form>
<br />
